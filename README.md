...
| `@shuji-bonji/houki-nta-mcp`       | v0.11.0 以上 (通達の応答の `base_laws` と `next_actions` で法律本文へ戻る手順を使うため。v0.10.0 以上ならエラー契約は同じで、v0.7.0 以上なら動作はする) | [npm](https://www.npmjs.com/package/@shuji-bonji/houki-nta-mcp)       | [GitHub](https://github.com/shuji-bonji/houki-nta-mcp)       |
